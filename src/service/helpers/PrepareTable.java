    ...
    public static void insertData(Connection conn){
        try {
            ...
            try {
                ...
                stmt.addBatch("INSERT INTO Citation (CitationNo, CitationDate, CitationTime, PaymentStatus, StaffID, LicenseNo, PLName, CitationName) VALUES ('NP1', '2021-10-11', '08:00:00', 'Complete', 2, 'VAN-9910', 'Dan Allen Parking Deck', 'No Permit'), ('EP1', '2023-10-01', '10:00:00', 'Pending', 2, 'CRICKET', 'Poulton Deck', 'Invalid Permit');");
